...
const speakingTimeline: TimelineItem[] = [
  {
    title: (
      <div className={"flex items-center gap-2"}>
        AI Fireside Chat x Michelin Dinner
        <Badge variant={"secondary"} className={"text-[10px] leading-3 px-1"}>
          Upcoming
        </Badge>
      </div>
    ),
    subtitle: "Failup Ventures, HOF Capital and UBS",
  ...
  },
  {
    title: (
      <a
        href={
          "https://www.linkedin.com/posts/slush_today-we-had-a-frunch-with-linda-bj%C3%B6rkenheim-activity-7387457868616249344-UfU5?utm_source=share&utm_medium=member_desktop&rcm=ACoAACjVgcoBvtmfbRWhpbZboPGurFsIqQ3VdVU"
        }
        target={"_blank"}
      >
        Slush Frunch
    ...
    subtitle: "Q&A with me and Linda Björkenheim from Legora",
    time: "October 23 2025",
  },
  {
    title: (
      <a href={"https://luma.com/nr6ewv51?tk=CGmV3B"} target={"_blank"}>
        Engineered Conversations
      </a>
    ),
    subtitle: "byFounders x Wave Ventures",
    time: "October 23 2025",
  },
  {
    title: (
...
const pressTimeline: TimelineItem[] = [
  {
    title: (
      <a
        ...
        href={"https://www.exceptionalcap.com/exceptional100_2025"}
        target={"_blank"}
      >
    ...
    subtitle:
      "Exceptional Capital’s annual list of the top 100 engineers, researchers, and designers shaping hyper-growth companies.",
    time: "",
  },
];
